...
DTS = DatasetMethods(dataset_path='WELFake_Dataset.csv')
...
# DTS.display_unique_values(column_name='label') # Label: 1: Count: 37106, Label: 0: Count: 35028

# Remove unwanted columns
# print(DTS.remove_columns_and_save(['Unnamed: 0']))

# # Remove rows with empty values by providing specific column names or
# # by providing an empty array [] to check all columns
# print(DTS.remove_rows_with_empty_fields(column_names=['title','text', 'label']))

# Merge column1 and column2 into a new column named merged_column, while keeping the remaining columns unchanged.
# print(DTS.merge_columns('title', 'text', 'Text'))

# Rename an existing column
# print(DTS.rename_column_in_csv('label', 'Label'))

# Create a new dataset with rows where the text in the column has less than max_len characters.
# print(DTS.remove_max_len_rows('Text', 2560))

# # Identify the unique labels in a specific column (column_name) to understand your dataset
# DTS.display_unique_values(column_name='Label') # Label: 1: Count: 20604, Label: 0: Count: 16005
...
# print(DTS.remove_rows_with_empty_fields(['Text','Label']))

# # Identify the unique labels in a specific column (column_name) to understand your dataset
# DTS.display_unique_values(column_name='Label') # Label: 1: Count: 20592, Label: 0: Count: 16005
...
# print(DTS.create_stratified_subset(total_rows=5000, stratified_column='Label'))

# # Identify the unique labels in a specific column (column_name) to understand your dataset
# DTS.display_unique_values(column_name='Label') # Label: 1: Count: 2500, Label: 0: Count: 2500
...
# print(DTS.split_dataset(stratify_column='Label'))

# Some extra checks for wrong types rows
# DTS2 = DatasetMethods(dataset_path='train_set.csv')
# Check if all entries in the specified column of the DataFrame match the expected type and return the IDs of rows that do not match.
# print(DTS2.check_column_types('id', 'Text', 'string')) # you can also check for label int